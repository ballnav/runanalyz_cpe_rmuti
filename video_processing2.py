...
from Project.calculate_angles2 import calculate_angle, calculate_trunk_lean, evaluate_angle, get_text_color, get_point, evaluate_each_body
from Project.running_phase_sub import RunningGaitCycleCounter
    ...
    with open(csv_filename, mode='w', newline='') as csv_file:
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                knee_optimal_map = {
                    ("Initial Contact", "Initial Contact"): (0, 35),  # มุมเข่าประมาณ 0-5 องศาในขณะสัมผัสพื้น
                    ("Midstance", "Midstance"): (15, 50),  # มุมเข่าประมาณ 15-20 องศาในช่วง Midstance
                    ("Terminal Stance", "Terminal Stance"): (20, 55),  # มุมเข่าประมาณ 20-30 องศาในช่วง Terminal Stance
                    ("Preswing", "Preswing"): (30, 65),  # มุมเข่าประมาณ 30-45 องศาในช่วง Preswing
                    ("Initial Swing", "Initial Swing"): (45, 80),  # มุมเข่าประมาณ 45-60 องศาในช่วง Initial Swing
                    ("Midswing", "Midswing"): (60, 95),  # มุมเข่าประมาณ 60-75 องศาในช่วง Midswing
                    ("Terminal Swing", "Terminal Swing"): (70, 105)  # มุมเข่าประมาณ 70-85 องศาในช่วง Terminal Swing
                }
